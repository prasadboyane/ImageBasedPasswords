...
<body>
                        ...
                        <ul class="nav navbar-nav">
                         <li class="dropdown" style="color:#FFF"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Account  <span class="caret"></span></a>
                                ...
                                <ul class="dropdown-menu">
                                        ...
                                        <li><a href="#"><li>Rolling Deposits</a></li>
                                    </ul>
                                </li>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-4 well well-sm col-md-offset-4">
            <legend><a href="http://www.jquery2dotnet.com"><i class="fa fa-star"></i></a>Create Request </legend>
            <form action="Requ" method="post" class="form" role="form">
                             
                <input class="form-control" style="margin-bottom:10px;" name="Acc" placeholder="Account Number" type="text" />
                                                <input class="form-control" style="margin-bottom:10px;" name="Reqno" placeholder="Request No." type="text" />
 <input class="form-control" style="margin-bottom:10px;" name="DOR" placeholder="Date of Request" type="date" />
                                <div class="form-control">
                                    <label for="occupation" style="margin-bottom:10px;"><span class="req"> </span>Type of Request</label>
                                    <select class="selectpicker" style="margin-left:55px;" name="TOR">
                                       
                                            <option>ChequeBook</option>
                                            <option>MobileBanking</option>
                                            <option>Netbanking</option>
                                            <option>Passbook</option>
            							    </select>
                                    
                                </div>
                                <textarea class="form-control" name="Comm" placeholder="Comments" type="text" style="margin-bottom:25px; margin-top:20px;"></textarea>
								
                 <button type="submit" class="btn btn-success btn-lg btn-round-lg" style="border-radius: 22.5px; width:100%;">Create</button>
            </form>
        </div>
    </div>
</div>
