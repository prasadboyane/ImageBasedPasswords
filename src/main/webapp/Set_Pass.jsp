...
<div id="container" >
	 ...
	 <br><br>
        <h4>Set password for user :<%= request.getAttribute("username")%></h4>
       <!--  <h4>Set password for user :demo100</h4> -->
         <input type="password" name="password" id="password"></input>
        <input type="hidden" name="username" id="username" value="<%= request.getAttribute("username")%>"></input> 
     <!--   <input type="hidden" name="username" id="username" value="demo100"></input> -->
...
PLUGINSPAGE="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash"> 
    ...
    <!--<img src="Koala.jpg" width="640" height="412"   STYLE="position:absolute; TOP:60px; LEFT:10px; z-index: -1;"/>  -->
   <!--  <img src="C:\Users\sahadev\Pictures.jpg" width="640" height="412"   STYLE="position:absolute; TOP:183px; LEFT:10px; z-index: -1;"/> -->
    
    
  <footer>
  <p>Home <a href="Index.jsp">Home</a></p>
</footer>
