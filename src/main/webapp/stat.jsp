...
<body>
                        ...
                        <ul class="nav navbar-nav">
                         <li class="dropdown" style="color:#FFF"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Account Summary <span class="caret"></span></a>
                                ...
                                <ul class="dropdown-menu">
                                        ...
                                        <li><a href="TranRet.jsp">Transfer Fund</a></li>
                                    </ul>
                                </li>
 ...
 try{
     ...
     PreparedStatement ps = saha.prepare("select * from deposit " );
...
%>
							...
							<h4><span>Account Statement</span></h4>
										<style>
.center {
    margin: auto;
    width: 600%;
...
if (rs.isExhausted()) {
 %>
      ...
      <%  } else {
           for (Row row : rs) { %>   
            ...
            <tr>
              <td><%=row.getString("tranid")%> </td>
              <td><%= row.getString("acc")%></td>
                <td><%=row.getString("bal")%> </td>
               <td><%= row.getString("dod")%></td>
                 <td><%= row.getString("part")%></td>
                    <td><%= row.getString("totbal")%></td>
 ...
 try{
     ...
     PreparedStatement ps = saha.prepare("select * from withdraw " );
      ...
      <%  } else {
           for (Row row : rs) { %>   
            ...
            <tr>
              <td><%=row.getString("bal")%> </td>
              <td><%= row.getString("acc")%></td>
                <td><%=row.getString("dow")%> </td>
               <td><%= row.getString("totbal")%></td>
                    <td><%= row.getString("wamt")%></td>
                    ...
                    <div class="span4">
                        <div class="block">
                            ...
                            <div class="block-content">
                                <p></p> <a href="#" class="btn"><i class="fw-icon-circle-arrow-right"></i> more</a> </div>
                        </div>
                    </div>
                    <div class="span4">
                        <div class="block">
