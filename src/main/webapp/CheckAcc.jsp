...
try{
     ...
     PreparedStatement ps = saha.prepare("select * from savings where Accno='"+Acc+"'");
 ...
 %>
      ...
      <%  } else {
           for (Row row : rs) { %>   
            ...
            <tr>
              <td><%=row.getString("first_name")%> </td>
              <td><%= row.getString("last_name")%></td>
                <td><%=row.getString("DOB")%> </td>
               <td><%= row.getString("address")%></td>
                 <td><%= row.getString("email")%></td>
                  <td><%= row.getString("phone")%></td>
                   <td><%= row.getString("pan")%></td>
                    <td><%= row.getString("aadhar")%></td>
                     <td><%= row.getString("Occ")%></td>
                      <td><%= row.getString("TOA")%></td>
                       <td><%= row.getString("JOI")%></td>
                        <td><%= row.getString("Accno")%></td>
                         <td><%= row.getString("ROI")%></td>
                          <td><%= row.getString("DOAO")%></td>
