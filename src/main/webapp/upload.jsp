...
<body>
    ...
    <div class="container">
        <div class="card card-container">
            <h3 class="text-center">Image Authentication Profile Create</h3>
            <form class="form-signin" method="POST"  action="uploadServlet" enctype="multipart/form-data">
                <span id="reauth-email" class="reauth-email"></span>
                <input type="text" name="username" value=${fname} >
                <input type="email" name="email" value=${email} >
                <input type="file" name="photo" class="form-control" placeholder="Upload Image" required>
                <div id="remember" class="checkbox">
                    <label>
                        <input type="checkbox" value="remember-me"> Remember Me
                    </label>
                </div>
                <button class="btn btn-lg btn-success btn-block btn-signin" type="submit">Upload And Create</button>
            </form>
        </div><!-- /card-container -->
    </div>
