...
<body>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-4 well well-sm col-md-offset-4">
            ...
            <div class="row">
                <div class="col-xs-6 col-md-6">
                 ...
                 <label for="" style="margin-left:20px;">First Name *</label><input class="form-control" style="margin-bottom:10px; margin-left:15px;"  name="firstname" placeholder="First Name" type="text"
                ...
                <div class="col-xs-6 col-md-6"><label>Last Name *</label>
                    <input class="form-control" style="margin-bottom:10px;" name="lastname" placeholder="Last Name" type="text" onkeypress="return onlyAlphabets(event,this);" data-validation-required-message="Please enter your name." />
                </div>
            </div>
               ...
               <div class="form-group">
                ...
                <label>Email *</label>
                <input class="form-control" style="margin-bottom:10px;" name="email" placeholder="Email" type="text" required />
     ...
     <label>Pan No *</label>
            <input class="form-control" style="margin-bottom:10px;" name="pan" placeholder="PAN No." type="text"  required/>
                <label>Aadhar No *</label>
                <input class="form-control" style="margin-bottom:10px;" maxlength="12"  name="aadhar" placeholder="Adhar No." type="text" required />
            ...
            <input class="form-control" style="margin-bottom:10px;" name="Accno" placeholder="Account No." type="text"  required/>
                ...
                <label for="Accno"><span class="req">Balance</span></label>
                            ...
                            <div class="form-group">
                                <label for="username"><span class="req">Rate of Interest</span></label>
							...
							<div class="form-group">
                                ...
                                <input class="form-control" type="text"  name="username" id="txt" onkeyup="Validate(this)" placeholder="User Name" required />
                                <div id="errLast"></div>
                            </div>
							<div class="form-group">
