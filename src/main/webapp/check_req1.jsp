...
<body>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-4 well well-sm col-md-offset-4">
            <legend><a href="Index2.jsp"><i class="fa fa-globe"></i></a> Check Your Balance</legend>
            <form action="Check1" method="POST" class="form" role="form">
            <div class="row">
                <div class="col-xs-6 col-md-6">
                    
                 <label for="" style="margin-left:20px;">Account Number</label><input class="form-control" style="margin-bottom:10px; margin-left:15px;" name="acc" placeholder="Account Number" type="text"
                        required autofocus />
                </div>
                            </div>
