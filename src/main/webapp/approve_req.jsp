...
<body>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-4 well well-sm col-md-offset-4">
            <legend style="margin-left:75px;"><a href="http://www.jquery2dotnet.com"></a>Approve Request</legend>
            <form action="Index2.jsp" method="post" class="form" role="form">
                <lable style="margin-bottom:10px;"><h4>A/c No.</h4></lable>
            <input class="form-control" style="margin-bottom:10px;" name="Account Number" placeholder="Account Number" type="text" />
                <lable style="margin-bottom:10px;"><h4>Request No.</h4></lable>
            <input class="form-control" style="margin-bottom:10px;" name="Request No." placeholder="Request No." type="text" />
                <lable style="margin-bottom:10px;"><h4>Date Of Request</h4></lable>
            <input class="form-control" style="margin-bottom:10px;" name="DOR" placeholder="Date of Request" type="date" />
                  <lable style="margin-bottom:10px;"><h4>Type of Request</h4></lable>
            <input class="form-control" style="margin-bottom:10px;" name="TOR" placeholder="Type of Request" type="text" />
                <lable style="margin-bottom:10px;"><h4>Current Balance</h4></lable>
            <input class="form-control" style="margin-bottom:10px;" name="CURRBAL" placeholder="Current Balance" type="text" />
         <lable style="margin-bottom:10px;"><h4>Withdrawal Amount</h4></lable>
            <input class="form-control" style="margin-bottom:10px;" name="Withdraw" placeholder="Withdrawal Amount" type="text" />
                <lable style="margin-bottom:10px;"><h4>Total Balance</h4></lable>
            <input class="form-control" style="margin-bottom:10px;" name="TOTBAL" placeholder="Total Balance" type="text" />
                
                <textarea class="form-control" name="comments" placeholder="Comments" type="text"
                          style="margin-bottom:10px; margin-top:20px;"></textarea>
<button onclick="getConfirmation();" class="btn-round btn btn-primary" style="margin-left:100px;">Approve</button>
            </form>
        </div>
    </div>
</div>
<!--========================REGISTRATION FORM END=================-->
  <script>
            ...
            function getConfirmation(){
               var retVal = confirm("Approve Request?");
               if( retVal == true ){
