...
<body>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-4 well well-sm col-md-offset-4">
            <legend style="margin-left:100px;"><a href="http://www.jquery2dotnet.com"></a>Upload Signature</legend>
            <form class="form-signin" method="POST"  action="uploaddoc1" enctype="multipart/form-data">
            ...
            <input class="form-control" style="margin-bottom:10px;" name="accno" value=${accno}  type="text" />
             <lable style="margin-bottom:10px;"><h4>Sign</h4></lable>
